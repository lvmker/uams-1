...
$.fn.pagination.defaults={total:1,pageSize:20,pageNumber:1,pageList:[20,50,100,200,500],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_c4,_c5){
...
if(tt.parent().children("span.tree-file").length||(!tt.hasClass("tree-hit")&&typeof bgidx=='object'&&bgidx.treeNotLeafSelected===true)){
  _180(_d6,_da[0]);
  _d7.onClick.call(_d6,_dd(_d6,_da[0]));
}else{
  _13a(_d6,_da[0]);
...
$.fn.filebox.defaults=$.extend({},$.fn.textbox.defaults,{buttonIcon:null,buttonText:"浏览",buttonAlign:"right"});
})(jQuery);
(function($){
function _49a(_49b){
...
if(str){
var as = str.split("-");
return new Date(parseInt(as[0], 10), parseInt(as[1], 10) - 1, parseInt(as[2], 10));
}}
var startDate = parse(opts.start);
var endDate = parse(opts.end);
////////////end
...
/////////////begin
var customDate = new Date(day[0], day[1] - 1, day[2]);
if((startDate && customDate < startDate) || (endDate && customDate > endDate)) {
cls+=" calendar-other-month calendar-day-disabled";
}
/////////////end
...
t.find("td.calendar-day.calendar-day-disabled").css("cursor", "default");/////////////////
t.find("td.calendar-day:not(.calendar-disabled,.calendar-day-disabled)").hover(function(){///////////////
...
var td=$("<td rowspan=\""+opts.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\">序号</div></td>");
if($("tr",t).length==0){
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:20,pageList:[20,50,100,200,500],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_74c,_74d){
...
_8a8.timer=setInterval(function(){
...
var opts=$(this).combobox("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>-1||row[opts.valueField].toLowerCase().indexOf(q.toLowerCase())>-1;
...
sc.calendar({start:opts.start,end:opts.end});//////////////////
}
_96b.calendar=sc;
}else{
_96b.calendar=$("<div></div>").appendTo(cc).calendar({start:opts.start,end:opts.end});//////////////////
}
