...
$wraper.append($year).append("年").append($month).append("月").append($day).append("日");
if (tabindex != null) {
...
$("<option value='0'></option>").appendTo($year);
$("<option value='0'></option>").appendTo($month);
$("<option value='0'></option>").appendTo($day);
}
