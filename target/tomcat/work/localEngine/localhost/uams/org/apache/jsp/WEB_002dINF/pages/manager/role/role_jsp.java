package org.apache.jsp.WEB_002dINF.pages.manager.role;
...
public final class role_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/WEB-INF/pages/manager/role/../../../../resources/common/page/sessionovertime.jsp");
    _jspx_dependants.add("/WEB-INF/pages/manager/role/../../../../resources/common/page/button.jsp");
  }
...
System.err.println(lang);
      ...
      // /WEB-INF/pages/manager/role/role.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("path");
      // /WEB-INF/pages/manager/role/role.jsp(4,0) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      ...
      out.write("/resources/uams/role.js\"></script>\r\n");
      out.write("\t\t<script type=\"text/javascript\" src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      ...
      out.write("\t\t\t\t<td  align=\"right\" width=\"80\" >角色名称：</td>\r\n");
      out.write("\t\t\t\t<td >\r\n");
      out.write("\t\t\t\t\t<input name=\"role.roleName\" class=\"easyui-textbox\" id=\"search_roleName\" data-options=\"prompt:'角色名称'\" style=\"width: 150px\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<!-- <td  align=\"right\" width=\"80\">系统名称：</td>\r\n");
      out.write("\t\t\t\t<td width=\"100\" align=\"left\">\t\t          \t\t\r\n");
      out.write("\t\t\t  \t\t<input class=\"easyui-combobox\" id=\"roleInfoDialog_sysNameFilt\" size=\"20\" editable=\"false\" data-options=\"\r\n");
      ...
      out.write("\t\t\t\t<a href=\"javaScript:openDialog_add();\" name=\"role_add\" style=\"float:left;\" class=\"easyui-linkbutton\" iconCls=\"icon-add\">添加</a>\r\n");
      out.write("\t\t        <div class=\"datagrid-btn-separator\"></div>\r\n");
      out.write("\t\t        <a href=\"javaScript:openDialog_edit();\" name=\"role_editor\" style=\"float:left;\" class=\"easyui-linkbutton\" iconCls=\"icon-edit\">编辑</a>\r\n");
      out.write("\t\t        <div class=\"datagrid-btn-separator\"></div>\r\n");
      out.write("\t\t        <a href=\"javaScript:delRole();\" name=\"role_delete\" style=\"float:left;\" class=\"easyui-linkbutton\" iconCls=\"icon-cancel\">删除</a>\r\n");
      out.write("\t\t        <div class=\"datagrid-btn-separator\"></div>\r\n");
      out.write("\t\t        <a href=\"javaScript:reloadRole();\" name=\"role_refresh\" style=\"float:left;\" class=\"easyui-linkbutton\" iconCls=\"icon-reload\">刷新</a>\r\n");
      out.write("\t\t        <div class=\"datagrid-btn-separator\"></div>\r\n");
      out.write("\t\t        <a href=\"javascript:queryRole()\" name=\"role_query\" class=\"easyui-linkbutton\" iconCls=\"icon-search\">查询</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 表格 -->\r\n");
      ...
      out.print( basePath);
      out.write("role/findUamsRoles.do\">\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t    <!-- 新增/修改表单dialog -->\r\n");
      out.write("\t    <div id=\"roleInfoDialog\" iconCls=\"icon-save\" style=\"width:400px;height:200px;\">\r\n");
      out.write("\t       <div class=\"easyui-layout\" fit=\"true\">\r\n");
      out.write("\t\t  \t<div region=\"center\" border=\"false\" style=\"padding-top:15px;padding-left:20px;\">\r\n");
      out.write("\t\t    \t<table class=\"fullTable\">\r\n");
      out.write("\t\t    \t\t\t<tr>\r\n");
      out.write("\t\t  \t\t\t\t\t<td class=\"tr\">角色ID:</td>\r\n");
      out.write("\t\t  \t\t\t\t\t<td>\r\n");
      out.write("\t\t  \t\t\t\t\t\t<input type=\"text\" size=\"40\" style=\"width: 249\" class=\"easyui-textbox\" maxlength=\"40\" data-options=\"required:true,missingMessage:'该输入项为必输项'\" id=\"roleInfoDialog_roleId\" ></input>\r\n");
      out.write("\t\t  \t\t\t\t\t\t<input type=\"hidden\" id=\"roleInfoDialog_roleId\" value=\"\"/>\r\n");
      out.write("\t\t  \t\t\t\t\t</td>\r\n");
      out.write("\t\t  \t\t\t\t</tr>\r\n");
      out.write("\t\t  \t\t\t\t<tr>\r\n");
      out.write("\t\t  \t\t\t\t\t<td class=\"tr\">角色名称:</td>\r\n");
      out.write("\t\t  \t\t\t\t\t<td>\r\n");
      out.write("\t\t  \t\t\t\t\t\t<input type=\"text\" size=\"40\" style=\"width: 249\" class=\"easyui-textbox\" maxlength=\"40\" data-options=\"required:true,missingMessage:'该输入项为必输项'\" id=\"roleInfoDialog_roleName\" ></input>\r\n");
      out.write("\t\t  \t\t\t\t\t\t<input type=\"hidden\" id=\"roleInfoDialog_roleId\">\r\n");
      out.write("\t\t  \t\t\t\t\t</td>\r\n");
      out.write("\t\t  \t\t\t\t</tr>\r\n");
      out.write("\t\t  \t\t\t\t<!-- <tr>\r\n");
      out.write("\t\t  \t\t\t\t\t<td class=\"tr\">系统名称:</td>\r\n");
      out.write("\t\t  \t\t\t\t\t<td>\r\n");
      out.write("\t\t  \t\t\t\t\t\t<input class=\"easyui-combobox\" id=\"roleInfoDialog_sysName\" size=\"40\" editable=\"false\" data-options=\"\r\n");
      out.write("\t\t\t          \t\t\tpanelHeight:'250',\r\n");
      out.write("\t\t\t          \t\t\tvalueField:'systemCode',\r\n");
      out.write("\t\t\t          \t\t\ttextField:'systemName',\r\n");
      out.write("\t\t\t          \t\t\turl:'./resources/findUamsResources.do',\r\n");
